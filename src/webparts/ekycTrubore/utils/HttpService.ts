...
export async function getHttpData(endpoint: string, props: IEkycTruboreProps): Promise<any> {
...
// // GET
//     async getHttpData(endpoint: string, props: IEkycTruboreProps): Promise<any> {
//         if (!props.currentSPContext) {
//             throw new Error("SP Context not available");
//         }
//         const response: HttpClientResponse = await props.currentSPContext.httpClient.get(
...
//     // PUT
//     async updateHttpData(endpoint: string, data: any, props: IEkycTruboreProps): Promise<any> {
//         if (!props.currentSPContext) {
//             throw new Error("SP Context not available");
//         }
...
//     // DELETE
//     async deleteHttpData(endpoint: string, props: IEkycTruboreProps): Promise<any> {
//         if (!props.currentSPContext) {
//             throw new Error("SP Context not available");
//         }
//         const response: HttpClientResponse = await props.currentSPContext.httpClient.fetch(
