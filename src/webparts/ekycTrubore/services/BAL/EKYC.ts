...
export interface IDashboardOps {
    getDashboardData(props: IEkycTruboreProps): Promise<IEKYC[]>;
  ...
  getDashboardItemById(listName: string ,id: number, props: IEkycTruboreProps): Promise<IEKYC>;
  insertDashboardData(item: IEKYC, props: IEkycTruboreProps): Promise<any>;
  updateDashboardData(id: number, item: IEKYC, props: IEkycTruboreProps): Promise<void>;
  preFillData(code: string, props: IEkycTruboreProps): Promise<{EmployeeName?: string; Department?: string}>;
...
export default function DashboardOps(): IDashboardOps {
    ...
    const getDashboardData = async ( props: IEkycTruboreProps): Promise<IEKYC[]> => {
    ...
    const getDashboardItemById = async (listName: string ,id: number, props: IEkycTruboreProps): Promise<IEKYC> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const preFillData = async (code: string, props: IEkycTruboreProps): Promise<{EmployeeName?: string; Department?: string}> => {
        try {
    ...
    const insertDashboardData = async (item: IEKYC, props: IEkycTruboreProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
    ...
    const updateDashboardData = async (id: number, item: IEKYC, props: IEkycTruboreProps): Promise<void> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
