...
export interface IDashboardOps {
    getHistoryData(ekycId: number,props: IEkycTruboreProps): Promise<IHistory[]>;
    insertHistoryData(item: KYCData, props: IEkycTruboreProps): Promise<any>;
...
export default function HistoryOps(): IDashboardOps {
    ...
    const getHistoryData = async (ekycId: number, props: IEkycTruboreProps): Promise<IHistory[]> => {
        ...
        try {
            ...
            const results = await spCrudOpsInstance.getData(
                "WorkflowHistory",
                "*,Id,Created,Modified,Remark,Author/Id,Author/Title,AttachmentFiles,AttachmentFiles/ServerRelativeUrl,AttachmentFiles/FileName",
    ...
    const insertHistoryData = async (item: KYCData, props: IEkycTruboreProps): Promise<any> => {
        try {
            const spCrudOpsInstance = await spCrudOps;
