...
import styles from './EkycTrubore.module.scss';
import type { IEkycTruboreProps } from './IEkycTruboreProps';
...
export default class EkycTrubore extends React.Component<IEkycTruboreProps> {
  public render(): React.ReactElement<IEkycTruboreProps> {
    const {
      description,
      isDarkTheme,
      environmentMessage,
    ...
    return (
      <section className={`${styles.ekycTrubore} ${hasTeamsContext ? styles.teams : ''}`}>
        <ParallaxProvider>
          <HashRouter>
